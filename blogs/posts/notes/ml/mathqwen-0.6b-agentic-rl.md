...
实际跑通了 40 步 SFT，`qlora/models/qlora_70b_sft/` 里的 train_info
记录了峰值显存 17.44 GB/卡——注意是每张卡，离 32 GB 的天花板还有一大截，
说明 batch 或者上下文长度还有往上加的空间。loss 正常收敛，这条路是通的。

我只是探索了一下“72B 能在一台双卡 5090 上训起来”这件事本身，
